        ...
        <div class="row gx-2 justify-content-center">
            <div class="col-4">
                ...
                <form class="register-form" id="register-create" method="POST" action="/categories/update/{{$category->slug}}">
                    ...
                    <input class="register-input-text" type="text" name="is_parent" id="is_parent" value="{{$category->is_parent}}" required>

                    <label class="register-label" for="parent_id">Parent id:</label>
                    <input class="register-input-text" type="text" name="parent_id" id="parent_id" value="{{$category->parent_id}}">

                    <label class="register-label" for="name">Name</label>
                    <input class="register-input-text" type="text" name="name" id="name" value="{{$category->name}}" required>

                    <label class="register-label" for="slug">Slug</label>
                    <input class="register-input-text" type="text" name="slug" id="slug" value="{{$category->slug}}" required>
